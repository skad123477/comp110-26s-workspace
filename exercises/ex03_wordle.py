...
def input_guess(secret_word_length: int) -> str: #creates the function to prompt the user to enter the guess.
    ...
    while len(guess) != secret_word_length: #this is a while loop that keeps prompting the user to enter a guess until it is the correct length of characters.
...
def contains_char(secret_word: str, char_guess: str) -> bool:
    ...
    assert len(char_guess) == 1 #Makes sure that char_guess is just a single character.
    idx: int = 0 #idx is short for index, this line initializes to start checking the characters at index 0.

    while idx < len(secret_word): #this loop as long as idx is less than the length of secret_word
...
def main(secret: str) -> None:
    ...
    while turns_taken < max_turns and not won:
        ...
        print(emoji_result) #prints the string of emojis to represent the accuracy of the guess.
